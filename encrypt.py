...
# coding: utf-8
# Janga Di Ubah Suuu
# By Ralan Musa: https://github.com/R4L4N-XD
...
print("➤ subscribe Yt gw dulu bro")
...
def check_update():
    global LATEST_VER
    LATEST_VER = requests.get('https://raw.githubusercontent.com/R4L4N-XD/Py-Fuscate/main/.version').text.strip()
